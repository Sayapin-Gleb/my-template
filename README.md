...
```bash
uvx cookiecutter [https://github.com/osprey-oss/cookiecutter-uv.git](https://github.com/Sayapin-Gleb/my-template.git)
```
...
cookiecutter [https://github.com/osprey-oss/cookiecutter-uv.git](https://github.com/Sayapin-Gleb/my-template.git)
```
